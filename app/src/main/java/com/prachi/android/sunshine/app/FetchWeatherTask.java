...
// you ever want to remove it.
        ...
        Log.i(LOG_TAG,"resultstring"+resultStrs);
        return resultStrs;
    }
    @Override
...
// http://openweathermap.org/API#forecast
            ...
            //builder.appendPath(baseUrl);
            builder.appendQueryParameter(city, params[0]);
            builder.appendQueryParameter(mode, modeType);
            builder.appendQueryParameter(count, countDays);
            builder.build();
...
// to parse it.
        ...
        try {
            getWeatherDataFromJson(forecastJsonStr, Integer.parseInt(countDays),locationQuery);
